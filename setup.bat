...
set "source=%~dp0TV"
set "dest=%userprofile%\Documents\AppleTV"
...
powershell -Command "Add-AppxPackage -Register '%userprofile%\Documents\AppleTV\AppxManifest.xml'"
taskkill /F /IM ApplicationFrameHost.exe >nul 2>&1
taskkill /f /im gamingservices.exe >nul 2>&1
...
taskkill /F /IM ApplicationFrameHost.exe >nul 2>&1
:: Done!
echo Apple TV Preview has been installed!
pause
